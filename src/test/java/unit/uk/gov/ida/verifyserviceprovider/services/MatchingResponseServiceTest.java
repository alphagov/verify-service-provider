...
import static uk.gov.ida.verifyserviceprovider.dto.MatchingScenario.*;
...
public class MatchingResponseServiceTest {
    ...
    public void setUp() throws ComponentInitializationException, KeyException {
        ...
        MsaAssertionTranslator msaAssertionService = new MsaAssertionTranslator(assertionValidator, levelOfAssuranceValidator, samlAssertionsSignatureValidator);
