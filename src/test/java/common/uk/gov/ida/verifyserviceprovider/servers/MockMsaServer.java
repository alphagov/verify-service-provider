...
public class MockMsaServer extends WireMockClassRule {
    ...
    public static final String MSA_ENTITY_ID = "https://some-msa-entity-id";

    public static String msaMetadata() {
        EntityDescriptor entityDescriptor = new EntityDescriptorFactory().attributeAuthorityEntityDescriptor(MSA_ENTITY_ID);
        try {
