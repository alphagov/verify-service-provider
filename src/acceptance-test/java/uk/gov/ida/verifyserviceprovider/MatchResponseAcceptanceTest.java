...
public class MatchResponseAcceptanceTest {
    ...
    private String successCaseURI;

    @Before
    public void setupComplianceTool() throws Exception {
        URL testDataURL = MatchResponseAcceptanceTest.class.getResource("/compliance-tool-service-test-data.json");
        ...
        successCaseURI = successCase.getString("executeUri");
    }
    ...
    public void shouldFoo() {
        ...
        String samlString = extractSamlResponse(responseHtmlString);

        assertThat(samlString).isNotEmpty();
    }
}
