...
public class MsaMetadataConfiguration extends MetadataConfiguration {
    ...
    public MsaMetadataConfiguration(
        ...
        super(uri, minRefreshDelay, maxRefreshDelay, expectedEntityId, jerseyClientConfiguration, ofNullable(jerseyClientName).orElse(MSA_JERSEY_CLIENT_NAME), hubFederationId);
    }
