...
public class UserAccountCreationAttributes implements Attributes {
    ...
    @JsonCreator
    public UserAccountCreationAttributes(
    ...
    public boolean equals(Object o) {
        ...
        UserAccountCreationAttributes that = (UserAccountCreationAttributes) o;
    ...
    public String toString() {
        return String.format(
            "UserAccountCreationAttributes{ firstName=%s, middleName=%s, surname=%s, dateOfBirth=%s, address=%s, addressHistory=%s, cycle3=%s}",
