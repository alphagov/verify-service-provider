...
public class AssertionServiceV1 implements AssertionService<TranslatedResponseBody> {


    private AssertionValidator assertionValidator;
    private SamlAssertionsSignatureValidator assertionsSignatureValidator;

    public AssertionServiceV1(AssertionValidator assertionValidator, SamlAssertionsSignatureValidator assertionsSignatureValidator ) {
