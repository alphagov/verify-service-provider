...
public class MsaResponderResponseTranslator implements ResponderResponseTranslator {
    @Override
    public TranslatedResponseBody translateResponderResponse(StatusCode statusCode) {
